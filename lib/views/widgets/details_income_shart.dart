...
class DetailsIncomeShart extends StatefulWidget {
  const DetailsIncomeShart({super.key});

  @override
  State<DetailsIncomeShart> createState() => _DetailsIncomeShartState();
}

class _DetailsIncomeShartState extends State<DetailsIncomeShart> {
